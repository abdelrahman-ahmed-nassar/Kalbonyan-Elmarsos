...
- [Section 3 Code](./code/-03-react-basics-%26-Working-with-components/expenses-app/)
- [Section 4 Code](./code/-04-react-state-%26-working-with-events/expenses-app/)
- [Section 5 Code](./code/-05-Rendering-lists-%26-conditional-content/expenses-app-project/)

  <br/>

- [Section 3 Project Live Demo](https://abdelrahman-expenses-app-v1.netlify.app/)
- [Section 4 Project Live Demo](https://abdelrahman-expenses-app-v2.netlify.app/)
- [Section 5 Project Live Demo](https://abdelrahman-expenses-app.netlify.app/)
...
- [Section 6 Code](./code/-06-styling-react-cmp/goals-app-project/)
- [Section 7 Code](./code/-07-debugging-react-apps/goals-app/)

<br/>

- [Section 6 Project Live Demo](https://abdelrahman-goals-app.netlify.app/)
- [Section 7 Project Live Demo](https://abdelrahman-goals-app-v2.netlify.app/)
...
- [Project-code](./code/-09-fragmants-portals-refs/users-app-project/)
- [Live Demo](https://abdelrahman-users-app.netlify.app/)
  ![users-app](./screens/users-app.png)
- [My optimized version](https://abdelrhman-ahmed-kamal.github.io/passwords-manager-app/)
  ![passwords-manager-app](./screens/users-app-optimized.png)

---

### Fake Login-app (S10)

- [Project-code](./code/-10-use-effect-reducer-context/fake-login-app-project/)
- [Live Demo](https://abdelrahman-fake-login-app.netlify.app/)
  ![fake-login app](./screens/fake-login-app.png)
...
- [Project-code](./code/-14-http-requests/movies-app-project/)
...
- [Project-code](./code/-15-custom-hooks/tasks-app-project/)
- [Live Demo](https://abdelrahman-tasks-app.netlify.app/)
  ![tasks](./screens/tasks-app-firebase.png)

### Timer app project(S15)

- [Project-code](./code/-15-custom-hooks/timer-app-project/)
- [Live Demo](https://abdelrahman-timer-app.netlify.app/)
  ![timer app](./screens/timer-app-custom-hooks.png)

---

### Form-app(S16)

- [Project-code](./code/-16-work-with-forms/form-validation-project/)
...
- [Project Code](./code/-17-practice-order-food-project/order-food-app-project/)
...
- [Project-code](./code/-18-redux/redux-app-project/)
...
- [Project-code](./code/-19-advanced-redux/redux-cart-project)
...
- [Project-code](./code/-22-authentication/auth-app-project/)
- [Live Demo](https://abdelrahman-auth.netlify.app/)
  ![auth](./screens/auth-app.png)

---

### Meetup app(S23)

- [Project-code](./code/-23-next-js/meetups-app-project/)
...
- [Project-code](./code/-24-animation-react/project/)
...
- [Project-code](./code/-25-replace-redux/products-app-project/)
...
- [Project-code](./code/-27-type-script/todo-app/)
...
- [Project-code](./code/-28-react-hooks-introduction/ingredients-app/)
...
- [Project-code](./code/-29-react-core-features/summary-project/)
- [Live Demo](https://abdelrahman-summary-app.netlify.app/)
  ![summary app](./screens/summary-app.png)
